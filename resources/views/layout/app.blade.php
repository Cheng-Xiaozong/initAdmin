...
<head>
    ...
    <title> 经销商后台管理系统 - @yield('title')</title>
...
@section('header')
    <header class="am-topbar am-topbar-inverse admin-header">
        <div class="am-topbar-brand">
            <strong>保农经销商</strong> <small>后台管理系统</small>
        </div>
            ...
            <ul class="am-list admin-sidebar-list" id="collapase-nav">
                ...
                <li class="admin-parent">
                    ...
                    <ul class="click-active am-list am-collapse admin-sidebar-sub am-in" id="article-nav">
                        <li><a data-href="{{url('/article')}}" class="am-cf"><span class="am-icon-th-list"></span> 订单管理</a></li>
                ...
                <li class="admin-parent">
                    <a class="am-cf am-collapsed" data-am-collapse="{parent: '#collapase-nav', target: '#push-nav'}"><span class="am-icon-cloud-upload"></span> 商品管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
